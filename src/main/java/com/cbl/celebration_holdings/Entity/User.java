package com.cbl.celebration_holdings.Entity;
...
public class User {
    ...
    public User(String user_name, String address, String tele, String nic, String created_date, String password, String cof_password, String user_type, int status) {
